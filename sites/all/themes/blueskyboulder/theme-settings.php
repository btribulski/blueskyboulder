 ...
 */
function blueskyboulder_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['blueskyboulder_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('blueskyboulder sample setting'),
  '#default_value' => theme_get_setting('blueskyboulder_example'),
