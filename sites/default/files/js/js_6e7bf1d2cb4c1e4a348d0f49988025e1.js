...
var narkism = { src: '/sites/all/themes/blueskyboulder/sifr3/narkism.swf' };
var bookantiqua = { src: '/sites/all/themes/blueskyboulder/sifr3/book-antiqua.swf' };
var cochin = { src: '/sites/all/themes/blueskyboulder/sifr3/demo/cochin.swf' };
var rockwell = { src: '/sites/all/themes/blueskyboulder/sifr3/demo/rockwell.swf' };
...
// Next, activate sIFR:
sIFR.activate(narkism, cochin, rockwell);
...
sIFR.replace(bookantiqua, {
  selector: 'h1.title',
  css: '.sIFR-root { background-color: #F9F9F9; color: #000066; }',
  wmode: 'transparent'
});
